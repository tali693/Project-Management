...
;( function( $ ) {
	...
	var ts = $.tablesorter = {
		...
		defaults : {
			...
			// *** appearance
			theme            : 'green',  // adds tablesorter-{theme} to the table for styling
			...
			sortRestart      : true,      /////// restart sort to 'sortInitialOrder' when clicking on previously unsorted columns
